...
class AdapterReferenceCollector {
     ...
     */
    static <T, A extends MvvmRecyclerAdapter<T>> WeakReference<A> createRef(A adapter, ObservableList<T> items, ObservableList.OnListChangedCallback callback) {
    ...
    static class AdapterRef<T, A extends MvvmRecyclerAdapter<T>> extends WeakReference<A> {
