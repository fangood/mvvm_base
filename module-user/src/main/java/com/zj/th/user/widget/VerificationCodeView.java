 ...
 *
 * @author https://github.com/JackTuoTuo/VerificationCodeView
 */
public class VerificationCodeView extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        LayoutInflater.from(context).inflate(R.layout.user_verification_code, this);
        ...
        if (mEtDividerDrawable == null) {
            mEtDividerDrawable = context.getResources().getDrawable(R.drawable.user_shape_verification_code_divider_identifying);
        }

        if (mEtBackgroundDrawableFocus == null) {
            mEtBackgroundDrawableFocus = context.getResources().getDrawable(R.drawable.user_shape_verification_code_icv_et_bg_focus);
        }

        if (mEtBackgroundDrawableNormal == null) {
            mEtBackgroundDrawableNormal = context.getResources().getDrawable(R.drawable.user_shape_verification_code_icv_et_bg_normal);
        }
    ...
    public void setEtNumber(int etNumber) {
        ...
        mEditText.removeTextChangedListener(myTextWatcher);
